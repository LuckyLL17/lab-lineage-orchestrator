...
func (value SampleBatch) Validate() error {
...
func (value SampleBatch) Key() string {
	return string(value.ID) + ":" + string(value.Status) + ":" + fmt.Sprint(value.Version)
}

func (value *SampleBatch) Prepare(now time.Time) {
...
func (value *SampleBatch) Advance(next Status, now time.Time) error {
...
func (value SampleBatch) View() EntityView {
	return EntityView{
		ID:        value.ID,
		Kind:      "sample-batches",
		Name:      value.Name,
