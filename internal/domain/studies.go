...
func (value *Study) Advance(next Status, now time.Time) error {
...
func (value Study) View() EntityView {
	return EntityView{
		ID:        value.ID,
		Kind:      "studies",
		Name:      value.Name,
