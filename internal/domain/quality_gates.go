...
type QualityGate struct {
	...
	MeasurementID ID                `json:"measurementID"`
	Threshold     float64           `json:"threshold"`
}

func (value QualityGate) Validate() error {
...
func (value QualityGate) Key() string {
	return string(value.ID) + ":" + string(value.Status) + ":" + fmt.Sprint(value.Version)
}

func (value *QualityGate) Prepare(now time.Time) {
...
func (value *QualityGate) Advance(next Status, now time.Time) error {
...
func (value QualityGate) View() EntityView {
	return EntityView{
		ID:        value.ID,
		Kind:      "quality-gates",
		Name:      value.Name,
