...
func (value AuditRecordEntry) Validate() error {
...
func (value AuditRecordEntry) Key() string {
	return string(value.ID) + ":" + string(value.Status) + ":" + fmt.Sprint(value.Version)
}

func (value *AuditRecordEntry) Prepare(now time.Time) {
...
func (value *AuditRecordEntry) Advance(next Status, now time.Time) error {
...
func (value AuditRecordEntry) View() EntityView {
	return EntityView{
		ID:        value.ID,
		Kind:      "audit-records",
		Name:      value.Name,
